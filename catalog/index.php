...
$content = str_replace("https://avatar.roblox.com", "/web", $content);
$content = str_replace("https://badges.roblox.com", "/web", $content);
$content = str_replace("https://catalog.roblox.com", "/web", $content);
$content = str_replace("https://games.roblox.com", "/web", $content);
$content = str_replace("https://groups.roblox.com", "/web", $content);
$content = str_replace("https://metrics.roblox.com", "/web", $content);
$content = str_replace("https://thumbnails.roblox.com", "/web", $content);
