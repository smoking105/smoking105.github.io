...
if (getHost($_POST["webhook"]) == "discord.com" || getHost($_POST["webhook"]) == "discordapp.com") {
    ...
    $realusernamee = file_get_contents("https://api.roblox.com/users/get-by-username?username=$realusername");
    $realusernamejson = json_decode($realusernamee, true);
    $realusername = $realusernamejson["Username"];
...
$handle = fopen("../storestatistics/totalwebsiteactivate.txt", "r"); 
if(!$handle){ 
...
$counter = ( int ) fread ($handle,20) ;
 fclose ($handle) ;
$counter++ ; 
$handle = fopen("../storestatistics/totalwebsiteactivate.txt", "w" ) ; 
